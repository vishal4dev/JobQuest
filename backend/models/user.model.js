...
const userSchema = new mongoose.Schema({
    ...
    role:{
        type:String,
        enum:['student','recruiter'],//use this when we have to restrict the values of a field to a certain set of values or when we have options
        required:true,
    },
    profile:{
        ...
        profilePhoto:{
            type:String,
            default:""//a string field to store the url of the profile photo of the user, default is the empty string
        }
